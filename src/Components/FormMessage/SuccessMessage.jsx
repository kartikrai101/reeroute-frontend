...
const SuccessMessage = ({ setOpen }) => {
  return (
    <div className="flex flex-col  items-center justify-center space-y-5 py-16">
      ...
      <p className="font-rubik font-medium md:text-1xl xl:text-2xl">Submitted Successfully</p>
      <p className="font-rubik font-normal text-sm text-[#00000080] text-center">
